...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}@{}/{}".format(
            'zachariah:123456', 'localhost:5432', self.database_name)
    ...
    def test_search_question(self):
        ...
        questions = Question.query.filter(
            Question.question.ilike(search_term2)).all()
    ...
    def test_quiz(self):
        ...
        questions = Question.query.filter(
            Question.category == self.quiz_req['quiz_category']['id']).all()
        formatted_questions = [question.format() for question in questions]
        data = json.loads(res.data)

        self.assertNotIn(data['question']['id'],
                         self.quiz_req['previous_questions'])
    ...
    def test_400_search_question(self):
        ...
        res = self.client().post('/questions', json=self.search_term3)
        data = json.loads(res.data)
